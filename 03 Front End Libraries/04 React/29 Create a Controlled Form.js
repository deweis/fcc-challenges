/**
* Task: The MyForm component is set up with an empty form with a submit handler.
...
* to submit indicating it is the button controlling the form. Add the input
* element in the form and set its value and onChange() attributes like the last
* challenge. You should then complete the handleSubmit method so that it sets
* the component state property submit to the current input value in the local
* state.
*
