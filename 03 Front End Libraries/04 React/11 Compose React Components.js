/**
* Task: In the code editor, the TypesOfFood component is already rendering a
* component called Vegetables. Also, there is the Fruits component from the last
* challenge.
*
* Nest two components inside of Fruits — first NonCitrus, and then Citrus. Both of
* these components are provided for you in the background. Next, nest the Fruits
