/**
* Task: The code editor has the skeleton of a component called ControlledInput
* to create a controlled input element. The component's state is already
* initialized with an input property that holds an empty string. This value
* represents the text a user types into the input field.
*
* First, create a method called handleChange() that has a parameter called
* event. When the method is called, it receives an event object that contains a
* string of text from the input element. You can access this string with
...
* attribute which is equal to the input property of the component's state.
...
* value in the input box on the page. The component state is the single source
