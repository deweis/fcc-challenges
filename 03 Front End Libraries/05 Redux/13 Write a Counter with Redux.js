/**
* Task: In this lesson, you'll implement a simple counter with Redux from
* scratch. The basics are provided in the code editor, but you'll have to fill
* in the details! Use the names that are provided and define incAction and
* decAction action creators, the counterReducer(), INCREMENT and DECREMENT
* action types, and finally the Redux store. Once you're finished you should be
