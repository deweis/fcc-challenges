/**
* Task: First, in the render() method, have the component render an input
* element, button element, and ul element. When the input element changes, it
* should trigger a handleChange() method. Also, the input element should render
* the value of input that's in the component's state. The button element should
...
class DisplayMessages extends React.Component {
  ...
  submitMessage() {
    ...
    messagesNew.push(this.state.input);
    this.setState({
  ...
  render() {
    const messageList = this.state.messages.map((message) => <li>{message}</li>);
